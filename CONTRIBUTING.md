...
Thanks for improving unidle. Keep changes focused, testable, portable, and honest about their evidence.
...
10. **Preserve unrelated user configuration.** Installer changes must validate container shapes, update atomically, and remove only unidle's own handlers.
