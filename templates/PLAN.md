...
Scope: <validated pipeline id; store this file at .unidle/<scope>/PLAN.md>
Depth: tree <N>
Mode: orchestrated
...
Append events to `.unidle/<scope>/status.log`; do not copy the event history into this file:
