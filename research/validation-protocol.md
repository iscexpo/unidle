...
Treat the historical comparison as design provenance only. It is too small for broad model claims and must not be described as proof that unidle causes a specific improvement or cost multiplier.
...
- exact unidle commit and condition definitions
